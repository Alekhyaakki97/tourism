...
if($lastInsertId)
{
$msg="Request  Successfully submited";
}
else
{
...
<html>
<head>
<title>Help-Efficient Tour Planning System</title>
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Tell us what you want to know</h3>
