...
$username=$_SESSION['alogin'];
	$sql ="SELECT Password FROM tagency WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tagency set Password=:newpassword where UserName=:username";
...
<html>
<head>
<title>Travel Agency Change Password</title>
