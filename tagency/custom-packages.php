				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Custom Packages</h2>
						...
						<tbody>
<?php $sql = "SELECT * from tblcustpackages";
...
{				?>		
						  <tr>
							...
							<td><a href="update-custom-price.php?pid=<?php echo htmlentities($result->BookingId);?>"><button type="button" class="btn btn-primary btn-block">Update</button></a></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
