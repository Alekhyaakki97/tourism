...
{
echo "The package has some issues. So we have to cancel the booking. Please verify new packages and book again";
...
<?php } else if($result->status==3) {
	?><td><a href="feedback.php?fid=<?php echo htmlentities($result->bookid);?>" >Feedback</a></td>
<?php } else {?>
